...
// This structure shall be used by the dijkstratime algorithm
class Tuppel
{
public:
    City* city;
...
QVector<Street*> dijkstratime::search(const AbstractMap &map, QString start, QString target)
{
    ...
    {
        qDebug() << "dijkstratime: Cities not found";
    ...
    {
        qDebug() << "dijkstratime: No Connection beetween the targets";
        QVector<Street*> l;
        return l;
    }
